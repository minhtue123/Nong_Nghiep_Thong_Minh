...
#define VISIONBOT_DEMO_WIFI_SSID "bailab"
#define VISIONBOT_DEMO_WIFI_PASS "12345678"
#define VISIONBOT_DEMO_MQTT_HOST "172.16.16.10"
...
void cameraPushEvent(WStype_t type, uint8_t *payload, size_t length) {
  switch (type) {
    case WStype_CONNECTED:
      ...
      publishSecurityEvent("camera_push_connected", "backend relay connected", "info");
      break;
